            ...
            <div className='max-w-3xl w-full rounded-md overflow-hidden border border-borderColor mt-6'>
                <table className='w-full border-collapse text-left text-sm text-gray-600'>
                    <thead className='text-gray-500'>
                        <tr>
                            <th className='p-3 fon-medium'>Car</th>
                            <th className='p-3 fon-medium max-md:hidden'>Date Range</th>
                            <th className='p-3 fon-medium'>Total</th>
                            <th className='p-3 fon-medium max-md:hidden'>Payment</th>
                            <th className='p-3 fon-medium'>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
